...
export const dom = {
  ...
  introDiffList: document.getElementById('introDiffList'),
  verseBookBtn: document.getElementById('verseBookBtn'),
  verseBookScreen: document.getElementById('verseBookScreen'),
  verseBookList: document.getElementById('verseBookList'),
  verseBookBackBtn: document.getElementById('verseBookBackBtn'),
  endFellLine: document.getElementById('endFellLine'),
