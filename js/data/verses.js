// Scripture (KJV, public domain) — tiered for difficulty variety.
export const VERSE_TIERS = {
  1: [
    ...
    { ref:"1 Thessalonians 5:19", text:"Quench not the Spirit." },
    { ref:"1 Thessalonians 5:20", text:"Despise not prophesyings." },
    ...
    { ref:"Exodus 20:13", text:"Thou shalt not kill." },
    { ref:"Exodus 20:15", text:"Thou shalt not steal." }
  ],
  2: [
...
// Satan's verses form a fixed ladder, one per round, shortest to longest —
// the same five warfare verses every run, in the same escalating order, so
// beating the game means having walked the whole ladder.
...
// The verse shown on the "game complete" screen.
export const VICTORY_VERSE = {
  ref:"2 Timothy 4:7",
...
export const CHAFF = ["therefore","wherefore","verily","peradventure","notwithstanding","howbeit","forasmuch",
  ...
  "yea","thus","hereby","selah","thereof","whereupon","hereafter","thenceforth","withal","perchance"];
